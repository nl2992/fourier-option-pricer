...
| Document | Contents |
|----------|----------|
| [model_zoo.md](model_zoo.md) | Complete catalogue of all 21 supported models  -  parameter dataclasses, CF sources, PyFENG dependency note, and `MODEL_REGISTRY` usage. |
