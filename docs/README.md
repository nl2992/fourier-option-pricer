...
| [bates_sv32_validation.md](bates_sv32_validation.md) | Detailed validation record for Bates (BATES-01–07) and 3/2 SV (SV32-01–05): parameters, reference types, tolerances, test-file links, and generated CSVs. |
...
| [methodology_and_results.md](../methodology_and_results.md) | Jump-convention derivation, MathWorks Bates mu_j conversion, reference values, and rationale for qualitative vs exact 3/2 SV validation. || [tests/README.md](../tests/README.md) | Test-folder map and `pytest` mark guide. |
