...
When `pyfeng_fft` appears in the validation docs, it refers to the PyFENG-backed Lewis-style FFT path used as a software-side oracle for supported models, distinct from the repo's own public `method="lewis"` (Lewis 2001, `foureng/pricers/lewis.py`).
