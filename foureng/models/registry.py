...
def _e(key, params_cls, cf, cumulants, pyfeng_fft):
    return ModelEntry(key=key, params_cls=params_cls, cf=cf,
                      cumulants=cumulants, pyfeng_fft=pyfeng_fft)
...
MODEL_REGISTRY: dict[str, ModelEntry] = {
    ...
    "rough_heston":  _e("rough_heston",  RoughHestonParams,    rough_heston_cf,   rough_heston_cumulants,   True),
    # ── In-house native CFs ───────────────────────────────────────────────────
    ...
    "heston_cgmy":           _e("heston_cgmy",           HestonCGMYParams,      heston_cgmy_cf,           heston_cgmy_cumulants,           False),
    "garch_wmw2012":         _e("garch_wmw2012",         GarchWMW2012Params,    garch_wmw2012_cf,         garch_wmw2012_cumulants,         False),
    ...
    "bilateral_gamma":       _e("bilateral_gamma",       BilateralGammaParams,  bilateral_gamma_cf,       bilateral_gamma_cumulants,       False),
